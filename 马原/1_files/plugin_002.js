...
'inputphone':(function(){
	...
	var lcnt = "";
	return {'show':function(){
			lcnt = "<div class=\"modal-header\"><button class=\"close\" type=\"button\" data-dismiss=\"modal\">×</button><h5>录入手机号</h5></div><div class=\"modal-body\"><form class=\"form-horizontal\" id=\"peinputform\" action=\"index.php?user-center-inputphone\" style=\"padding-top:20px;\"><div class=\"control-group\"><label class=\"control-label\" for=\"inputEmail\">手机号</label><div class=\"controls\"><input name=\"phone\" type=\"text\" needle=\"needle\" msg=\"请输入正确格式的手机号\"/></div></div></div></div></form></div><div class=\"modal-footer\"><button class=\"btn btn-primary\" type=\"button\" onclick=\"javascript:$('#peinputform').submit();\">确定</button></div>";
			l.html(lcnt);
			l.find("form").on('submit',formsubmit);
			l.modal({});
		},
